...
const StepTxt = ["Upon receiving a Purchase Order from 123 Importing, the exporter (Zen Export International) sends a\n" +
"Pro Forma Invoice (also referred to as a Commercial Invoice)",

    "123 Importing applies for the letter of credit with its bank in New York",

    "The bank accepts this application and proceeds for the letter of credit, and sends the irrevocable letter of credit to the bank in Japan, requesting a confirmation.",

    "The bank in Japan presents the negotiable letter of credit to the beneficiary (exporter), Zen Export International.",
    ...
    "After the goods are loaded and placed onboard the vessel for shipment to New York, the freight forwarder completes the necessary documentation and receives the necessary documentation from the shipping carrier.",


    "The key documents returned to the forwarder is the original set of onboard ocean bill of lading, consigned to the order of the bank, and marked Notify Applicant-123 Importing Company, New York",
    ...
    "In order to have the shipping company release the goods to the Customs broker, the broker must return\n" +
